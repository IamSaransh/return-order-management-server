...
@ContextConfiguration(classes = {IntegralItemRepairService.class})
@ExtendWith(SpringExtension.class)
class IntegralItemRepairServiceTest {
    @Autowired
    ...
    /**
     * Method under test: {@link IntegralItemRepairService#getProcessDetail(ProcessingRequest)}
     */
    @Test
    void testGetProcessDetail() {
        ...
        ResponseEntity<ProcessingResponse> actualProcessDetail = integralItemRepairService
        ...
        assertEquals(500, body.getProcessingCharge());
    ...
    void testGetProcessDetail2() {
        ...
        //       at me.saransh13.service.IntegralItemRepairService.getProcessDetail(IntegralItemRepairService.java:46)
        ...
        processingRequest.setUserContactNumber("42");
        processingRequest.setUsername("janedoe");
        integralItemRepairService.getProcessDetail(processingRequest);
    }
}
